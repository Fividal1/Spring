...
public class PostagemController {
	 ...
	 * tb_postagem. Observe que nesta linha foi utilizado um recurso chamado Java Generics, 
	 ...
	 * o valor de resposta (objeto do tipo Postagem com o retorno do método findById(id) no método: 
